...
#input("Please make sure all python scripts have been moved the _cell_fitness_folder/python_scripts folder.  Press enter to continue")
def _run_all_indels():
            ...
            with open(all_indels_script, "rt") as script:
                ...
                for line in code:
                    if line.startswith("    fastq_files = "):
                        ...
                        line = line.replace(line, "    fastq_files = 'Miller-Plate[1][1][78]*.fastq'\n" )
