    ...
    if filepath == -1:
        ...
        if LHAprimer3file == -1:
            ...
            with open(filepath, "r") as gbk_file:
                    ...
                    for line in lines:
                        if str('Sequence="'+RHAprimers_Dict.get(ID+".3gen.DS.R")) in line:
                            #print(line)
                            print("\nThis program has already added primers to this gbk file!\n\n\n")
                            for feat in genome.features:
                            
                                qualifierDict = feat.qualifiers
                                if qualifierDict.get('label') == [ID+".5gen.DS.F"] or qualifierDict.get('label') == [ID+".5gen.DS.F2"] or qualifierDict.get('label') == [ID+".5gen.DS.F3"]:
                                ...
                                if qualifierDict.get('label') == [ID+".3gen.DS.R"] or qualifierDict.get('label') == [ID+".3gen.DS.R"] or qualifierDict.get('label') == [ID+".3gen.DS.R"]:
            ...
            if not qualifier_label_list:
                ...
                (RHAprimers_Dict.get(ID+".3gen.DS.R"), ID+".3gen.DS.R")]: 
                    ...
                    if ("SSDNA" in filename.upper() or "MEGAMER" in filename.upper()) and name == ID+".5gen.DS.F":
                        name = ID+".5gen.DS.F"
                    if ("SSDNA" in filename.upper() or "MEGAMER" in filename.upper()) and name == ID+".3gen.DS.R":
                        name = ID+".3gen.DS.R"
                    #if (filename.upper().__contains__("SSDNA") or filename.upper.__contains__("MEGAMER")) and name == ID+".5gen.DS.F":
                    #    name = ID+".5gen.DS.F"
                    #if (filename.upper().__contains__("SSDNA") or filename.upper.__contains__("MEGAMER")) and name == ID+".3gen.DS.R":
                    #    name = ID+".3gen.DS.R"
            ...
            # If found, adds incremented number to the end of primer name then creates feature and adds it to the genbank file
                ...
                (RHAprimers_Dict.get(ID+".3gen.DS.R"), ID+".3gen.DS.R")]:     
                    ...
                    if any(ext in filename.upper() for ext in ssDNA_list) and name == ID+".5gen.DS.F":
                        name = ID+".5gen.DS.F"
                    if any(ext in filename.upper() for ext in ssDNA_list) and name == ID+".3gen.DS.R":
                        name = ID+".3gen.DS.R"
                    #    )
                    #if (filename.upper().__contains__("SSDNA") or filename.upper.__contains__("MEGAMER")) and name == ID+".5gen.DS.F":
                    #    name = ID+".5gen.DS.F"
            ...
            if ismatch == -1:
                return
            primers_table = [[names[0], LHAprimers_Dict.get(ID+".5gen.DS.F")],
                                [names[1], LHAprimers_Dict.get(ID+".5junc.DS.R")],
                                [names[2], RHAprimers_Dict.get(ID+".3junc.DS.F")],
                                [names[3], RHAprimers_Dict.get(ID+".3gen.DS.R")]]
            primers_df = pd.DataFrame(data=primers_table, columns=["Name", "Sequence"])
            #print(primers_df)
            #print(summary_frame)
            print('\nPrimers Table\n')

            if names[0] == ID+".5gen.DS.F" and names[3] == ID+".3gen.DS.R":
                print("\n")
                print(LHAprimers_Dict.get(ID+".5gen.DS.F"),'\t', names[0], "\n")
                print(LHAprimers_Dict.get(ID+".5junc.DS.R"),'\t', names[1],"\n")
                print(RHAprimers_Dict.get(ID+".3junc.DS.F"),'\t', names[2],"\n")
                print(RHAprimers_Dict.get(ID+".3gen.DS.R"),'\t', names[3], "\n")
            
                print("\n")
                print(str("CTACACGACGCTCTTCCGATCT"+LHAprimers_Dict.get(ID+".5gen.DS.F")),"\n")
                print(str("CAGACGTGTGCTCTTCCGATCT"+LHAprimers_Dict.get(ID+".5junc.DS.R")))
                print(str("CTACACGACGCTCTTCCGATCT"+RHAprimers_Dict.get(ID+".3junc.DS.F")),"\n")
                print(str("CAGACGTGTGCTCTTCCGATCT"+RHAprimers_Dict.get(ID+".3gen.DS.R")))
                print("\n")
                print(names[0],"\n")
                print(names[1],"\n")
                print(names[2],"\n")
                ...
                print("\n",LHAprimers_Dict.get(ID+".5gen.DS.F"),': ', names[0], "\n", LHAprimers_Dict.get(ID+".5junc.DS.R"),': ', names[1],"\n")
                print("",RHAprimers_Dict.get(ID+".3junc.DS.F"),': ', names[2],"\n",RHAprimers_Dict.get(ID+".3gen.DS.R"),': ', names[3], "\n")
            
                print("\n",str("CTACACGACGCTCTTCCGATCT"+LHAprimers_Dict.get(ID+".5gen.DS.F"))),"\n ",str("CAGACGTGTGCTCTTCCGATCT"+LHAprimers_Dict.get(ID+".5junc.DS.R"))
                print(str("CTACACGACGCTCTTCCGATCT"+RHAprimers_Dict.get(ID+".3junc.DS.F")),"\n ",str("CAGACGTGTGCTCTTCCGATCT"+RHAprimers_Dict.get(ID+".3gen.DS.R")),"\n")
                print(names[0],"\n",names[1])
                print(names[2],"\n",names[3],"\n\n")
                print("---adding new primers--\n\n\n")
...
def GC_Content(filepath, RHAprimers_Dict, LHAprimers_Dict, ID):
    ...
    for feat in genome.features: 
        ...
        #print(LHAprimers_Dict)
        #print(ID+".5gen.DS.F")
        #print(LHAprimers_Dict.get(ID+".5gen.DS.F"))
        #print(LHAprimers_Dict.get(ID+".5junc.DS.R"))
        #print(RHAprimers_Dict.get(ID+".3junc.DS.F"))
        #print(RHAprimers_Dict.get(ID+".3gen.DS.R"))
        # print("qualifier seq:", qualifierDict.get('Sequence'))
        
        if qualifierDict.get('Sequence') == [LHAprimers_Dict.get(ID+".5gen.DS.F")]:
        ...
        if qualifierDict.get('Sequence') == [RHAprimers_Dict.get(ID+".3gen.DS.R")]:
    ...
    #Need to clean up the BioPython output to get the numerical start/stop sequences
...
def primer3call(ID, arm):
    ...
    for try_number in range (1, 5):
        ...
        if str(data['PRIMER_LEFT_NUM_RETURNED']) >='1':
            ...
            LHAprimers_0[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_0_SEQUENCE'))
            LHAprimers_0[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_0_SEQUENCE'))
            LHAprimers_1[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_1_SEQUENCE'))
            LHAprimers_1[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_1_SEQUENCE'))
            LHAprimers_2[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_2_SEQUENCE'))
            LHAprimers_2[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_2_SEQUENCE'))
            LHAprimers_3[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_3_SEQUENCE'))
            LHAprimers_3[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_3_SEQUENCE'))
            LHAprimers_4[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_4_SEQUENCE'))
            LHAprimers_4[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_4_SEQUENCE'))

            LHAprimers_5[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_5_SEQUENCE'))
            LHAprimers_5[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_5_SEQUENCE'))
            LHAprimers_6[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_6_SEQUENCE'))
            LHAprimers_6[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_6_SEQUENCE'))
            LHAprimers_7[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_7_SEQUENCE'))
            LHAprimers_7[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_7_SEQUENCE'))
            LHAprimers_8[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_8_SEQUENCE'))
            LHAprimers_8[ID+'.5junc.DS.R'] = str(data.get('PRIMER_RIGHT_8_SEQUENCE'))
            LHAprimers_9[ID+'.5gen.DS.F'] = str(data.get('PRIMER_LEFT_9_SEQUENCE'))
...
def RHAprimer3call(ID, folder):
    ...
    for x in range (1, 5):
        if str(ID+".3gen.DS.R") in RHAprimers_4:
        ...
        if str(data['PRIMER_LEFT_NUM_RETURNED']) >='1':
            ...
            RHAprimers_0[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_0_SEQUENCE'))
            RHAprimers_1[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_1_SEQUENCE'))
            RHAprimers_1[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_1_SEQUENCE'))
            RHAprimers_2[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_2_SEQUENCE'))
            RHAprimers_2[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_2_SEQUENCE'))
            RHAprimers_3[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_3_SEQUENCE'))
            RHAprimers_3[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_3_SEQUENCE'))
            RHAprimers_4[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_4_SEQUENCE'))
            RHAprimers_4[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_4_SEQUENCE'))
            
            RHAprimers_5[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_5_SEQUENCE'))
            RHAprimers_5[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_5_SEQUENCE'))
            RHAprimers_6[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_6_SEQUENCE'))
            RHAprimers_6[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_6_SEQUENCE'))
            RHAprimers_7[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_7_SEQUENCE'))
            RHAprimers_7[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_7_SEQUENCE'))
            RHAprimers_8[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_8_SEQUENCE'))
            RHAprimers_8[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_8_SEQUENCE'))
            RHAprimers_9[ID+'.3junc.DS.F'] = str(data.get('PRIMER_LEFT_9_SEQUENCE'))
            RHAprimers_9[ID+'.3gen.DS.R'] = str(data.get('PRIMER_RIGHT_9_SEQUENCE'))
...
#Defintes the region to search for primers. ie Ls is X bp upstream of the LHA and Le is X bp downstream of the LHA end point
