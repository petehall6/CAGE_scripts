...
#TODO fixed to run from where the script is run
#list_of_files = glob.glob(r"C:\Users\jklein1\Downloads\TargetedDeepSequencing_Excel Export*.xls")
...
def send_project(NGS_df):
    ...
    if PI == "Kanneganti, Thirumala-Devi":
        PI = "Kanneganti, Thirumala-Devi; malireddi.subbarao@stjude.org"
