...
user_gid = "me"
workspace_gid = '12574667816162'
team_gid = '1205173703968384'
cert_loc = r'C:\Users\phall3\Desktop\asana.pem'
...
def get_workspace_info(api_client):
    ...
    workspace_gid = "12574667816162" # str | Globally unique identifier for the workspace or organization.
    opts = {
...
# create an instance of the API class
    ...
    project_gid = 1208800351892122 # str | Globally unique identifier for the project.
    opts = {
...
def get_projects(api_client):
    projects_api_instance = asana.ProjectsApi(api_client)
    team_gid = "1205173703968384" # str | Globally unique identifier for the team.
    opts = {
