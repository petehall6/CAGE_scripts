...
class NGS_Tab_Sample_Num(tbs.Frame):
    def __init__(self, master_window):
        ...
        self.srm_sample = tbs.StringVar(value="")
    ...
    def load_srm(self):
        ...
        for srm in srm_list:
            for entry in srm:
                ...
                self.srm_sample = srm[1]
                self.requested_by = srm[2]
                self.PI = srm[3]
                self.project_number = srm[4]
                self.gene = srm[5]
                self.user_comments = srm[6]
    ...
    def generate_emails(self):
        ...
        def _get_attachment(email, srm_sample, ngs_date):
            ...
            srm_excel_list = glob.glob(ngs_dir+f"/**/*{srm_sample}**",recursive=True)
            srm_dir_text_list = []
        ...
        for entry in srm_entries:
            ...
            srm_number, srm_sample, requested_by, pi, project_num, gene, user_comment = entry
            ...
            email = _get_attachment(email,srm_sample, ngs_date)
