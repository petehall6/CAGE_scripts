...
def call_offinder():
    ...
    offinder_call = f'bsub -P Cas_offinder -q gpu_short -gpu "num=1/host" -R a100 -M 10000 -o offinder_summary.txt -e offinder_error_log.txt -J cas_offinder_library "hostname & cas-offinder {input_guides} G accessory_files/CasOffinder_Results.txt"'
...
def update_mageck():
    ...
    mageck_name = input("Enter updated mageck file name: ").strip()
