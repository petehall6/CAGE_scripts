...
class Tails_Tab(tbs.Frame):
    def __init__(self, master_window):
        ...
        self.debug_mode = tbs.StringVar(value="")
        self.data = []
        self.cage_data = []
    ...
    def create_buttons(self):
        ...
        self.debug_button = tbs.Checkbutton(
            master = self.button_container,
            text = "Debug Mode",
            command = self.debug_mode_change,
            onvalue = 'on',
            offvalue='off',
        ...
        self.debug_button.grid(column=1,row=3,sticky=E)
    ...
    def create_comboxes(self):
        ...
        outcomes = [' ','Yes','No']
        edits = [' ','KO','KI','CKO','Del','ssODN','Point Mutation','Data']
        injection = [' ', 'END USER', 'TCU', 'NEL']
        department = [' ','CBT', 'CMB', 'Comp Bio', 'DNB', 'Pharm Sciences', 'Struct Bio', 'Tumor Bio', 'BMT', 'Infect Dis', 'Immuno','Hema' ]
    ...
    def debug_mode_change(self):
        ...
        debug_active = self.debug_mode.get().lower()
        print("Debug On")
        print(debug_active)
        return debug_active
    ...
    def generate_emails(self):
        ...
        def _update_excel(pi, requested_by, department, gene, edit, edit_size, injection_core, cage_number, ngs_date, success_num, submitted_num, notes, success):
            ...
            if str(pi) == str(requested_by):
                investigators = str(requested_by)
            else:
        ...
        def _email_writer(pi, requested_by, department, gene, edit, edit_size, injection_core, cage_number, ngs_date, success, success_num, submitted_num, notes, srm_number):
            ...
            def _body_builder(pi,requested_by,sample_type,success,edit,gene,cage_number):
                ...
                if pi.split(",")[1] == requested_by.split(",")[1]:
                    greeting = f"""Hello {pi.split(",")[1]}"""
                ...
                if sample_type =="Tail Snip/Toe Snip":
                    if success.upper() == "YES":
                        if edit.upper() == "CKO":
                            ...
                            {greeting},
                            <br><br>
                            Great news! {success_num} of the {gene} {edit} animals are positive for both the 5' and 3' loxP sites.  
                            ...
                            {greeting},
                            <br><br>
                            Great news! {success_num} of the {gene} {edit} animals contain out of frame indels (highlighted in green).
                            ...
                            {greeting},
                            <br><br>
                            Great news! {success_num} of the {gene} {edit} animals contain both the 5' and 3' junctions between your desired integration and your target site..
                            ...
                            {greeting},
                            <br><br>
                            Great news! {success_num} of the {gene} deletion animals contain deletions.
                            ...
                            {greeting},
                            <br><br>
                            Great news! {success_num} of the {gene} ssODN animals contain your desired mutation.
                            ...
                            {greeting},
                            <br><br>
                            Great news! {success_num} of the {gene} point mutation animals contain your desired mutation.
                            The CAGE number for this site is {cage_number}.
                            <br><br>
                            Don't hesitate to contact me if you have any questions.
                            <br><br>
                    ...
                    elif success == " ": #should catch when success is blank for when data is just sent to enduser
                        body=f"""
                        <font face="Calibri, Calibri, monospace">
                        {greeting},
                        <br><br>
                    ...
                    {greeting},
                                <br><br>
                                Attached is the NGS data for your {gene} project.
                                The CAGE number for this site is {cage_number.upper()}.
                                <br><br>
                                Don't hesitate to contact me if you have any questions.
                                <br><br>
                                Best,
            ...
            def _get_cc_list(injection_core, requested_by):

                cc_list = ["Shondra Miller"]
                
                if injection_core == 'TCU':
                    cc_list.append('Ahn, Youngwook') 
            ...
            email_cc = _get_cc_list(injection_core, requested_by)
        ...
        if self.debug_mode.get().lower() == "on":
            ...
            gene="PMH"
            sample_num="111111"
            sample_format="Well of plate"
            sample_type="Tail Snip/Toe Snip"
            department="Hema"
            success="YES"
            success_num="test" 
            submitted_num="test"  
            edit="KO"
            edit_size="test"
            injection_core="END USER" 
            ngs_date="040924" 
            cage_programs=["CAGE2904_mBoc_F_R"]
            notes="TEST DEBUG"
