    ...
    def generate_emails(self):
        ...
        def _email_writer_multi(project_df):
            ...
            def _body_builder(srm_order_num,greeting, scope, cell_line, objective, line_lead):
                ...
                body = f"""{greeting},
                <br><br>
                The following projects are ready for pickup:
                <br><br>
                <ul>
                {bullets}
                </ul>
                <br><br>
                We have a contactless pickup system in place.  
                Please arrange a time window with XXXXX in which someone can pick up the cells and will place your frozen 
                vials of cells into a dry ice bucket in M4170.  
                The dry ice bucket will be straight in front as you walk in.  
                Your live cultures will be in the top incubator to the right of the dry ice bucket on the bottom shelf. 
                Please also bring dry ice for the pickup.<br>
                <br>
